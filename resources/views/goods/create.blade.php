...
<form class="form-horizontal" role="form" action="{{url('/goods/store')}}" method="post"enctype="multipart/form-data">
 @csrf
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="file" class="form-control" name="goods_logo" id="firstname" placeholder="请输入图片">
    </div>
  </div>
  <div class="form-group">
    <label for="firstname" class="col-sm-2 control-label">商品简介</label>
    <div class="col-sm-10">
      <textarea class="form-control" id="firstname" name="goods_desc" placeholder="请输入简介"></textarea>
    </div>
  </div>
  <div class="form-group">
